...
const SCRAPERAPI_KEY = process.env.SCRAPERAPI_KEY; // tu clave de ScraperAPI
...
app.get('/search', async function(req, res) {
    ...
    try {
        // Hacemos la petición a ScraperAPI
        var apiUrl = 'http://api.scraperapi.com/';
        var params = {
            api_key: SCRAPERAPI_KEY,
            url: targetUrl,
            render: 'false' // sin render JS, solo HTML estático
        };
        ...
        // Filtramos solo algunos elementos visibles en HTML estático
        ...
        // Si no hay resultados, podemos devolver un mensaje de ejemplo
        if (results.length === 0) {
            results.push({
